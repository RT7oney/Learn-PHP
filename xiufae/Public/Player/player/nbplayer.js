...
function Init() {
    ...
    Niba.Buffer='http://player.nbplay.cn/ad.html';  
    }
    if(Niba.Pause==null || Niba.Pause==""){  
    Niba.Pause='http://player.nbplay.cn/ad.html';  
    } 
...
function ShowInstallInfo() {
    IsIeInstalled = false;
    AdObj.style.display = "none";
	NBPlayerBox.style.cssText="margin-top:150px";
...
function PlayNext() {
    if (Niba.NextPageUrl != '') {
        top.location.href = Niba.NextPageUrl;
    }
}
