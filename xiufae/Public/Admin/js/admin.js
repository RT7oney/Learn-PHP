	...
	for(var i =(currentPage-1)*5; i < Page; i++)
	 {
		...
		ajax_url+="<li style=\"width: 10%;FLOAT: left;text-align:center;\"><a href=\"javascript:ajaxpalyer('/index.php?s=/Admin/Collect/player/url/"+playUrl[1].replace('//','@')+"/type/"+playname+"')\">播放</a></li>";
	 }
	ajax_url+="</ul>";
