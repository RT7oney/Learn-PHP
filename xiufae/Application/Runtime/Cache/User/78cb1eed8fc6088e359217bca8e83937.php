...
<body>
<div class="vbox m-t-xl">
    <div class="container aside-xxl">
		<div class="panel panel-default">
            <header class="panel-heading font-bold">跳转提示</header>
            <div class="panel-body text-center system-message">
                <?php if(isset($message)) {?>
                <h1 class="glyphicon glyphicon-ok-sign text-info"></h1>
                <p class="success text-success"><?php echo($message); ?></p>
                <?php }else{?>
                <h1 class="glyphicon glyphicon-info-sign text-warning"></h1>
                <p class="error text-danger"><?php echo($error); ?></p>
                <?php }?>
                <p class="jump">页面自动 <a id="href" href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></p>
            </div>
		</div> 
    </div>
</div>
