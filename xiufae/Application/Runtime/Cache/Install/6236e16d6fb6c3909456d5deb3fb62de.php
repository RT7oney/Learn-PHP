...
<html>
    <head>
        ...
        <link href="/xiufae3/Public/static/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="/xiufae3/Public/Install/css/install.css" rel="stylesheet">
        <script src="/xiufae3/Public/static/jquery.js"></script>
        <script src="/xiufae3/Public/static/bootstrap/js/bootstrap.min.js"></script>
    </head>
    <body>
        <div class="navbar navbar-default navbar-static-top">
        	<div class="navbar-header">
				...
				<a href="http://www.lfdycms.com" class="nav-logo"><img src="/xiufae3/Public/Install/images/logo.png" alt="lfdycms"></a>
			</div>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); defined('SAE_MYSQL_DB') or define('SAE_MYSQL_DB', 'lfdycms'); ?>
    <h1>创建数据库</h1>
    <form action="/xiufae3/install.php?s=/install/step2.html" method="post" target="_self" class="form-horizontal">
