...
##################################################
// $nativeLink->setParameter("body", "H5支付测试"); //商品描述
// $timeStamp = time();
// $out_trade_no = WxPayConf_pub::APPID . "$timeStamp";
// $nativeLink->setParameter("out_trade_no", "$out_trade_no"); //商户订单号
// $nativeLink->setParameter("total_fee", "1"); //总金额
// $nativeLink->setParameter("notify_url", WxPayConf_pub::NOTIFY_URL); //通知地址
// $nativeLink->setParameter("trade_type", "NATIVE"); //交易类型
// $nativeLink->setParameter("product_id", "1234567789"); //交易类型
// $nativeLink->setParameter("spbill_create_ip", $_SERVER['REMOTE_ADDR']); //终端ip
##################################################
//获取链接
$product_url = $nativeLink->getUrl();
// var_dump($product_url);die;
