...
class AYDB {
	...
	public function zifuzhuan($data) {
		...
		if (!get_magic_quotes_gpc()) {
			return addslashes(str_replace(array('0xbf27', '0xbf5c27'), "'", $data));
		} else {
			return $data;
		}
	...
	public function zhixing($moth = '', $sql = '') {
		...
		if ($moth == 'scjg') {
			...
			if ($result->num_rows == 0) {
				...
				return $result->fetch_array(true);
			}
	...
	public function zhixing($moth = '', $sql = '') {
		...
		if ($moth == 'scjg') {
			...
			if (mysql_num_rows($result) == 0) {
				...
				return mysql_fetch_row($result, true);
			}
